...
import { Plus, Trash2, Tv, Eye, EyeOff, Save, X, Globe, Share2, Link as LinkIcon, Loader2, CheckCircle2, MessageCircle, Mail } from 'lucide-react';
...
const ManageChannels: React.FC<ManageChannelsProps> = ({ channels, onUpdateChannels }) => {
    ...
    const [formData, setFormData] = useState<{ email: string; credentials: string }>({
        email: '',
        credentials: ''
    });
