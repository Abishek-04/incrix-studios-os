...
const DailyTasks: React.FC<DailyTasksProps> = ({ tasks, users, currentUser, onUpdateTasks }) => {
...
const TaskItem: React.FC<{ task: DailyTask, onToggle: (id: string) => void, onDelete: (id: string) => void }> = ({ task, onToggle, onDelete }) => {
    return (
